    ...
    public static class Reflector
    {
        ...
        public static IEnumerable<Func<bool>> GetInitializerMethods()
        {
            return from assembly in AppDomain.CurrentDomain.GetAssemblies()
                ...
                let serverModuleAttribute =
                    Attribute.GetCustomAttribute(type, typeof(ServerModuleAttribute)) as ServerModuleAttribute
                where serverModuleAttribute != null
                from method in type.GetMethods()
                let initMethodAttribute =
                    Attribute.GetCustomAttribute(method, typeof(InitializerMethodAttribute)) as
                        InitializerMethodAttribute
                where initMethodAttribute != null
                orderby serverModuleAttribute.InitializationStage
        ...
        public static IEnumerable<Action> GetCleanupMethods()
        {
            return from assembly in AppDomain.CurrentDomain.GetAssemblies()
                ...
                from method in type.GetMethods()
                let initMethodAttribute =
                    Attribute.GetCustomAttribute(method, typeof(CleanUpMethodAttribute)) as CleanUpMethodAttribute
                where initMethodAttribute != null
