        ...
        public static void MasterList(WorldClient client, Packet packet)
        {
            ...
            using (var ppacket = new Packet(SH14Type.GroupList))
            {
                ...
                foreach (var stat in list)
                {
                    ...
                    ppacket.WriteHexAsBytes(
                        "00 00 00 00 44 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 8C 8E CD 00 88 49 DF 4E B3 08 4C 00 78 26 43 00 01 00 00 00 5A 68 42 00 18 FE 64 02 40 55 DF 4E 08 27 4D 00 94 FF 64 02 24 00 00 00 BD 68 42 00 87 BE");
                }
