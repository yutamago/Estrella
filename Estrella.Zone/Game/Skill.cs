    ...
    public class Skill
    {
        ...
        public Skill(ZoneCharacter c, ushort id)
        {
            ...
            Program.CharDBManager.GetClient()
                .ExecuteQuery("INSERT INTO Skillist (ID,Owner,SkillID,Upgrades,IsPassive) VALUES ('" + c.Character.ID +
                              "','" + db.SkillID + "','" + db.Upgrades + "','" + Convert.ToInt32(IsPassive) + "')");
            skill = db;
        }

        public ushort ID
        {
            get { return (ushort) skill.SkillID; }
            set { skill.SkillID = (short) value; }
        }

        public short Upgrades
        {
            get { return skill.Upgrades; }
            set { skill.Upgrades = value; }
        }

        public bool IsPassive
        {
            get { return skill.IsPassive; }
            private set { skill.IsPassive = value; }
        }

        public ActiveSkillInfo Info
        {
            get { return DataProvider.Instance.ActiveSkillsByID[ID]; }
        }
